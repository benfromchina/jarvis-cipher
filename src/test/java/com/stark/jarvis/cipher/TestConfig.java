...
public class TestConfig {
    ...
    static {
        try {
            ...
            CLIENT_PRIVATE_KEY = PemUtils.loadPrivateKeyFromString(CLIENT_PRIVATE_KEY_STRING);
            ...
            CLIENT_PUBLIC_KEY = PemUtils.loadPublicKeyFromString(CLIENT_PUBLIC_KEY_STRING);
